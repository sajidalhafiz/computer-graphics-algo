...
int main(){
    ...
    int outcode1=getcode(x1,y1), outcode2=getcode(x2,y2); //outcode1=5 and outcode2=0

    int accept=0;
    while(1){
        float m=(float)(y2-y1)/(x2-x1);// 1

        if((outcode1 | outcode2)==0){//(outcode1 & outcode2) == 0; completely inside
            accept=1; break;
        }
